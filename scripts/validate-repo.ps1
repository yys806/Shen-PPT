...
Assert-Path (Join-Path $rootItem.FullName 'scripts\shen_ppt_engine.py') 'Missing Shen-PPT deterministic code engine'
Assert-Path (Join-Path $rootItem.FullName 'scripts\build_shen_ppt_com.ps1') 'Missing Shen-PPT PowerPoint COM renderer'
Assert-Path (Join-Path $rootItem.FullName 'tests\test_shen_ppt_engine.py') 'Missing Shen-PPT engine regression tests'
